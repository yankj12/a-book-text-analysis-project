 ...
 *
 */
public class NovelCrawlServiceBXWXImpl implements NovelCrawlService{
	...
	public NovelCrawlServiceBXWXImpl(){
		// 初始化参数
		this.init();
	}
...
//				System.out.println(chapterRelativeUrl);
	...
	public String requestUrlByGetMethod(String url) {
		...
		httpget.addHeader("Host", "www.bxwx.la");
		...
		httpget.addHeader("Cookie", "__jsluid=386fb235646a61b507e7d19b86155dbe; bookid=10160%2C13370; chapterid=6018130%2C7291141; chaptername=%25u5927%25u7ED3%25u5C40%25u7AE0%253A%25u6167%25u773C%25u8BC6%25u624D%2C8-1%2520%25u5927%25u5F00%25u53D1%25u5012%25u95ED%25u4E86; bcolor=; font=; size=; fontcolor=; width=");
