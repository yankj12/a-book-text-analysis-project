 ...
 *
 */
public class NovelCrawlServiceYBDUImpl implements NovelCrawlService{
	...
	public NovelCrawlServiceYBDUImpl(){
		// 初始化参数
		this.init();
	}
...
//				System.out.println(chapterRelativeUrl);
	...
	public String requestUrlByGetMethod(String url) {
		...
		httpget.addHeader("Host", "www.ybdu.com");
		...
		httpget.addHeader("Cookie", "Hm_lvt_a1b17bf301c6a7aa3a0ba9cce1414f7a=1533356555,1533484333,1533562179; cscpvrich8519_fidx=7; Hm_lpvt_a1b17bf301c6a7aa3a0ba9cce1414f7a=1533562179");
